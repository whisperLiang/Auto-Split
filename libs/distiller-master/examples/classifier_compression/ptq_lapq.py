...
def image_classifier_ptq_fake(model, criterion, loggers, args):
    args = deepcopy(args)
    ...
    model, qp_dict = lapq.ptq_fake(quantizer, dummy_input, eval_fn, test_fn=test_fn,
...
if __name__ == "__main__":
    ...
    image_classifier_ptq_fake(cc.model, cc.criterion, [cc.pylogger, cc.tflogger], cc.args)
