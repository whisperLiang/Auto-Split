...
from  distiller.model_summaries import model_summary,export_img_classifier_to_onnx
import distiller.apputils as apputils
import os
import numpy as np
from tools.bit_search.compression.classifier_ptq_bit_search import image_classifier_ptq_bit_search
from tools.bit_search.compression import parser
...
def handle_subapps(model, criterion, optimizer, compression_scheduler, pylogger, args):
    ...
    if args.summary:
        ...
        for summary in args.summary:
            model_summary(model, summary, args.dataset)
        do_exit = True
    elif args.export_onnx is not None:
        export_img_classifier_to_onnx(model,
        ...
        if args.quantize_eval and args.qe_lapq:
            image_classifier_ptq_bit_search(model, criterion, pylogger, args)
        else:
