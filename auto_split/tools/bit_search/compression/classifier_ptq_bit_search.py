...
import distiller
from distiller.utils import yaml_ordered_load,yaml_ordered_save
import distiller.apputils as apputils
# import distiller.apputils.image_classifier as classifier
# import distiller.quantization.ptq_coordinate_search as lapq

import tools.bit_search.compression.image_classifier as classifier
import distiller.quantization.ptq_bit_search as lapq
# from tools.bit_search import quantization
msglogger = logging.getLogger()

def image_classifier_ptq_bit_search(model, criterion, loggers, args):
    args = deepcopy(args)
    ...
    model, qp_dict = lapq.ptq_bit_search(quantizer, dummy_input, eval_fn, test_fn=test_fn,
    ...
    # yaml_ordered_save('%s.quant_params_dict.yaml' % args.arch, qp_dict)
    #
    # apputils.save_checkpoint(0, args.arch, model,
...
if __name__ == "__main__":
    ...
    image_classifier_ptq_bit_search(cc.model, cc.criterion, [cc.pylogger, cc.tflogger], cc.args)
