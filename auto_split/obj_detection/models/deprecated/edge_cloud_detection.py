...
from obj_detection.pq_detection.engine import evaluate
...
if __name__ == '__main__':
    ...
    split_detection_model = split_fasterrcnn_resnet50_fpn(edge_dnn=quantizer_model, pretrained=True, num_classes=91)
