...
from obj_detection.models.detection_edge_dnn import EdgeDNN
...
if __name__ == '__main__':
    ...
    # orig_detection_model = torch_detection.__dict__[args.model](num_classes= num_classes,
    #                                                       pretrained=True)
    ...
    msglogger.info('Quantizing Edge model')
    edge_dnn, features = edge_dnn.ptq_edge_dnn()
